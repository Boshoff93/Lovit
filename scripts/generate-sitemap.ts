...
function generateSitemap(): string {
  ...
  const staticRoutes = [
    ...
    { path: '/docs/getting-started', priority: '0.75', changefreq: 'monthly' },
    { path: '/docs/music', priority: '0.75', changefreq: 'monthly' },
    { path: '/docs/voiceover', priority: '0.75', changefreq: 'monthly' },
    { path: '/docs/video', priority: '0.75', changefreq: 'monthly' },
    { path: '/docs/ugc', priority: '0.75', changefreq: 'monthly' },
    { path: '/docs/character-swap', priority: '0.75', changefreq: 'monthly' },
    { path: '/docs/assets', priority: '0.75', changefreq: 'monthly' },
    { path: '/docs/social', priority: '0.75', changefreq: 'monthly' },
    { path: '/docs/agent-integration', priority: '0.75', changefreq: 'monthly' },
    { path: '/analytics', priority: '0.7', changefreq: 'daily' },
    { path: '/analytics/tiktok', priority: '0.7', changefreq: 'daily' },
    { path: '/analytics/youtube', priority: '0.7', changefreq: 'daily' },
