...
interface VideoShowcaseProps {
  ...
  /** Called when CTA button is clicked (when ctaLink is not provided) */
  onCtaClick?: () => void;
  darkMode?: boolean;
  /** Custom gradient background - overrides darkMode background */
  gradientBackground?: string;
  /** Custom play button color - defaults to orange for dark mode, purple for light */
  playButtonColor?: string;
  /** Custom badge background color - overrides darkMode badge background */
  badgeBackground?: string;
  /** Custom badge text color - overrides darkMode badge color */
  badgeColor?: string;
  /** Custom CTA button gradient - overrides darkMode button gradient */
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <PlayArrowRoundedIcon sx={{ fontSize: 22, color: playButtonColor || (darkMode ? '#F97316' : '#8B5CF6'), ml: 0.25 }} />
            </Box>
          </Box>
        </Box>
      </Box>
        ...
        >
          ...
          {badge && (
            <Chip
              ...
              sx={{
                mb: 2,
                background: badgeBackground || (darkMode ? 'rgba(249, 115, 22, 0.2)' : 'rgba(139, 92, 246, 0.1)'),
                color: badgeColor || (darkMode ? '#FB923C' : '#8B5CF6'),
                fontWeight: 600,
                fontSize: '0.75rem',
                letterSpacing: '0.02em',
                height: 28,
          ...
          <Box sx={{ textAlign: 'center' }}>
            {ctaLink ? (
              <Button
                ...
                sx={{
                  background: (ctaButtonGradient || 'linear-gradient(135deg, #3B82F6 35%, #00D4AA 100%)') + ' !important',
                  ...
                  boxShadow: ctaButtonGradient ? '0 8px 24px rgba(249, 115, 22, 0.35)' : '0 4px 20px rgba(59, 130, 246, 0.4)',
                  ...
                  '&:hover': {
                    ...
                    boxShadow: ctaButtonGradient ? '0 12px 32px rgba(249, 115, 22, 0.45) !important' : '0 8px 24px rgba(59, 130, 246, 0.5) !important',
                  },
                }}
              >
                {ctaText}
