...
export const routeConfigs: { [key: string]: RouteConfig } = {
  ...
  '/': {
    ...
    heroHeading: 'UGC Agent Gruvi Reporting for Duty\nContent on Autopilot',
  ...
  '/create-content-without-camera': {
    ...
    title: 'Create Content Without a Camera - AI Content Generator | Gruvi',
    description: 'Create stunning video content without ever picking up a camera. Our AI transforms your ideas into professional videos with visuals, music, and effects. Perfect for introverts, busy entrepreneurs, and anyone who wants to create without filming.',
    keywords: 'create content without camera, faceless content creation, ai content generator, no filming videos, content creation for introverts, ai visual content, video without recording',
    ogTitle: 'Create Content Without a Camera - AI Content Generator',
    ogDescription: 'No camera? No problem. Create professional video content with AI. Transform ideas into stunning visuals without filming yourself.',
    twitterTitle: 'Create Content Without a Camera - AI Content Generator',
    twitterDescription: 'No camera? No problem. Create professional video content with AI.',
    breadcrumbName: 'Create Content Without Camera',
    heroTagline: 'Camera-Free Content Creation',
    heroHeading: 'Create Content\nWithout a Camera',
    heroSubtext: 'Transform your ideas into professional video content without ever picking up a camera. Our AI generates stunning visuals with music and effects - perfect for introverts, busy entrepreneurs, and anyone who wants to create without filming.',
    examplePrompts: ['Business promo without filming', 'Product video no camera needed', 'Social media content faceless', 'Marketing video without appearing'],
    routeCategory: 'contentCreator'
  },

  '/promote-business-without-filming': {
    path: '/promote-business-without-filming',
    title: 'Make Your Business Go Viral with AI Music | Gruvi',
    description: 'Make your business go viral without appearing on camera. Create professional promotional videos using AI-generated visuals with music. Perfect for business owners who want to grow their brand without the awkwardness of self-filming.',
    keywords: 'make business go viral, viral business marketing, ai business videos, faceless business promotion, marketing for camera shy, ai promotional content, ai music marketing',
    ogTitle: 'Make Your Business Go Viral with AI Music',
    ogDescription: 'Make your business go viral without appearing on camera. AI creates stunning promotional videos with music that convert.',
    twitterTitle: 'Make Your Business Go Viral with AI Music',
    twitterDescription: 'Make your business go viral without appearing on camera. AI creates stunning promotional videos with music.',
    breadcrumbName: 'Make Business Go Viral',
    heroTagline: 'Go Viral Without the Camera',
    heroHeading: 'Make Your Business Go Viral\nWith AI Music',
    heroSubtext: 'Make your business go viral without appearing on camera. Create professional promotional videos using AI-generated visuals with music. Perfect for business owners who want to grow their brand without the awkwardness of self-filming.',
    examplePrompts: ['Viral business promo video', 'Service showcase that goes viral', 'Company intro video faceless', 'Small business viral marketing'],
    routeCategory: 'promotional'
  },

  '/promote-brand-with-music': {
    path: '/promote-brand-with-music',
    title: 'Promote Your Brand with AI Video Content | Gruvi',
    description: 'Create viral video content that showcases your brand. AI-powered video generation combines your brand message with catchy music and stunning visuals. Stand out on social media without expensive production costs.',
    keywords: 'promote brand with video, ai brand video marketing, brand content videos, viral brand content, ai brand promotion, video marketing',
    ogTitle: 'Promote Your Brand with AI Video Content',
    ogDescription: 'Create viral video content for your brand. AI combines your message with catchy music and stunning visuals.',
    twitterTitle: 'Promote Your Brand with AI Video Content',
    twitterDescription: 'Create viral video content for your brand with AI.',
    breadcrumbName: 'Promote Brand with Music',
    heroTagline: 'Brand Marketing Made Simple',
    heroHeading: 'Promote Your Brand\nWith AI Video Content',
    heroSubtext: 'Create viral video content that showcases your brand. AI-powered video generation combines your brand message with catchy music and stunning visuals. Stand out on social media without expensive production costs.',
    examplePrompts: ['Brand anthem video', 'Product promo with music', 'Company theme video', 'Catchy brand promotion'],
    routeCategory: 'promotional'
  },

  '/promote-amazon-store-no-camera': {
    path: '/promote-amazon-store-no-camera',
    title: 'Promote Your Amazon Store Without a Camera | Gruvi',
    description: 'Market your Amazon FBA products without filming yourself. Create engaging product showcase videos with AI-generated visuals and music. Perfect for Amazon sellers who want professional content without the hassle of video production.',
    keywords: 'amazon store promotion, fba marketing no camera, amazon seller videos, product showcase ai, amazon marketing videos, faceless amazon content',
    ogTitle: 'Promote Your Amazon Store Without a Camera',
    ogDescription: 'Create stunning product videos for your Amazon store. AI generates professional showcases - no filming required.',
    twitterTitle: 'Promote Your Amazon Store Without a Camera',
    twitterDescription: 'Create stunning product videos for your Amazon store with AI.',
    breadcrumbName: 'Promote Amazon Store',
    heroTagline: 'Amazon Marketing Without Filming',
    heroHeading: 'Promote Your Amazon Store\nWithout a Camera',
    heroSubtext: 'Market your Amazon FBA products without filming yourself. Create engaging product showcase videos with AI-generated visuals and music. Perfect for Amazon sellers who want professional content without video production hassle.',
    examplePrompts: ['Amazon product showcase video', 'FBA listing promo content', 'Product review style video', 'Amazon storefront promotion'],
    routeCategory: 'ecommerce'
  },

  '/promote-app-without-filming': {
    path: '/promote-app-without-filming',
    title: 'Promote Your App Without Filming Yourself | Gruvi',
    description: 'Market your mobile app or software without appearing on camera. Create compelling app demo videos and promotional content using AI. Perfect for indie developers and startups who want professional marketing without video production costs.',
    keywords: 'app promotion no camera, mobile app marketing ai, software promotion videos, app demo ai, indie developer marketing, faceless app promotion',
    ogTitle: 'Promote Your App Without Filming Yourself',
    ogDescription: 'Create compelling app promo videos without filming. AI transforms your app into viral-worthy content.',
    twitterTitle: 'Promote Your App Without Filming Yourself',
    twitterDescription: 'Create compelling app promo videos without filming.',
    breadcrumbName: 'Promote App Without Filming',
    heroTagline: 'App Marketing Without Camera',
    heroHeading: 'Promote Your App\nWithout Filming Yourself',
    heroSubtext: 'Market your mobile app or software without appearing on camera. Create compelling app demo videos and promotional content using AI. Perfect for indie developers and startups who want professional marketing.',
    examplePrompts: ['App store promo video', 'Mobile app demo content', 'Software feature showcase', 'Startup app marketing video'],
    routeCategory: 'promotional'
  },

  '/promote-airbnb-without-camera': {
    path: '/promote-airbnb-without-camera',
    title: 'Promote Your Airbnb Without a Camera | Gruvi',
    description: 'Create stunning property showcase videos for your Airbnb or vacation rental without filming. AI generates beautiful visual tours with music that make your listing stand out. Perfect for hosts who want more bookings without video production hassle.',
    keywords: 'airbnb promotion no camera, vacation rental videos, property showcase ai, airbnb marketing, rental listing videos, faceless airbnb content',
    ogTitle: 'Promote Your Airbnb Without a Camera',
    ogDescription: 'Create stunning property showcase videos for your Airbnb. AI generates beautiful visual tours that drive bookings.',
    twitterTitle: 'Promote Your Airbnb Without a Camera',
    twitterDescription: 'Create stunning Airbnb showcase videos with AI.',
    breadcrumbName: 'Promote Airbnb Without Camera',
    heroTagline: 'Airbnb Marketing Made Easy',
    heroHeading: 'Promote Your Airbnb\nWithout a Camera',
    heroSubtext: 'Create stunning property showcase videos for your Airbnb or vacation rental without filming. AI generates beautiful visual tours with music that make your listing stand out and drive more bookings.',
    examplePrompts: ['Airbnb property tour video', 'Vacation rental showcase', 'Beach house promo content', 'Luxury rental marketing video'],
    routeCategory: 'airbnb'
  },

  '/promote-products-without-filming': {
    path: '/promote-products-without-filming',
    title: 'Promote Your Products Without Filming Yourself | Gruvi',
    description: 'Create professional product videos without appearing on camera. AI generates stunning product showcases with music and effects that sell. Perfect for e-commerce sellers, dropshippers, and product-based businesses.',
    keywords: 'product promotion no camera, ecommerce videos ai, product showcase videos, dropshipping content, faceless product marketing, ai product videos',
    ogTitle: 'Promote Your Products Without Filming Yourself',
    ogDescription: 'Create professional product videos without filming. AI generates stunning showcases that convert.',
    twitterTitle: 'Promote Your Products Without Filming Yourself',
    twitterDescription: 'Create professional product videos without filming.',
    breadcrumbName: 'Promote Products Without Filming',
    heroTagline: 'Product Marketing Without Camera',
    heroHeading: 'Promote Your Products\nWithout Filming Yourself',
    heroSubtext: 'Create professional product videos without appearing on camera. AI generates stunning product showcases with music and effects that sell. Perfect for e-commerce sellers, dropshippers, and product-based businesses.',
    examplePrompts: ['E-commerce product video', 'Dropshipping promo content', 'Product showcase with music', 'Online store marketing video'],
    routeCategory: 'ecommerce'
  },

  '/faceless-content-creator': {
    path: '/faceless-content-creator',
    title: 'Faceless Content Creator - Build Your Brand Anonymously | Gruvi',
    description: 'Build a successful content brand without showing your face. AI creates engaging videos with visuals and music while you stay behind the scenes. Join thousands of faceless creators building audiences on TikTok, YouTube, and Instagram.',
    keywords: 'faceless content creator, anonymous content creation, build brand without face, faceless youtube, faceless tiktok, ai content creation',
    ogTitle: 'Faceless Content Creator - Build Your Brand Anonymously',
    ogDescription: 'Build a successful content brand without showing your face. AI creates engaging videos while you stay anonymous.',
    twitterTitle: 'Faceless Content Creator - Build Your Brand Anonymously',
    twitterDescription: 'Build a successful content brand without showing your face.',
    breadcrumbName: 'Faceless Content Creator',
    heroTagline: 'Stay Anonymous, Go Viral',
    heroHeading: 'Faceless Content Creator\nBuild Your Brand Anonymously',
    heroSubtext: 'Build a successful content brand without showing your face. AI creates engaging videos with visuals and music while you stay behind the scenes. Join thousands of faceless creators building audiences on TikTok, YouTube, and Instagram.',
    examplePrompts: ['Faceless YouTube channel content', 'Anonymous TikTok videos', 'No-face Instagram reels', 'Behind-the-scenes creator content'],
    routeCategory: 'contentCreator'
  },

  '/viral-tiktok-without-camera': {
    path: '/viral-tiktok-without-camera',
    title: 'Go Viral on TikTok Without a Camera | Gruvi',
    description: 'Create viral TikTok content without filming yourself. AI generates trending-style videos with visuals, music, and effects that capture attention. Perfect for growing your TikTok following without appearing on camera.',
    keywords: 'viral tiktok no camera, faceless tiktok, tiktok content ai, trending videos no filming, tiktok growth no camera, ai tiktok videos',
    ogTitle: 'Go Viral on TikTok Without a Camera',
    ogDescription: 'Create viral TikTok content without filming. AI generates trending videos that grow your following.',
    twitterTitle: 'Go Viral on TikTok Without a Camera',
    twitterDescription: 'Create viral TikTok content without filming.',
    breadcrumbName: 'Viral TikTok Without Camera',
    heroTagline: 'TikTok Fame Without Filming',
    heroHeading: 'Go Viral on TikTok\nWithout a Camera',
  ...
  '/viral-youtube-content': {
    path: '/viral-youtube-content',
    title: 'Create Viral YouTube Content with AI Music | Gruvi',
    description: 'Create viral YouTube content without filming yourself. AI generates engaging videos with custom music and stunning visuals. Perfect for growing your YouTube channel without appearing on camera.',
    keywords: 'viral youtube content, youtube content ai, faceless youtube, youtube growth no camera, ai youtube videos, youtube content creation',
    ogTitle: 'Create Viral YouTube Content with AI',
    ogDescription: 'Create viral YouTube content without filming. AI generates engaging videos with custom music that grow your channel.',
    twitterTitle: 'Create Viral YouTube Content with AI',
    twitterDescription: 'Create viral YouTube content without filming yourself.',
    breadcrumbName: 'Viral YouTube Content',
    heroTagline: 'YouTube Growth Without Camera',
    heroHeading: 'Create Viral YouTube Content\nWith AI Music',
    heroSubtext: 'Create viral YouTube content without filming yourself. AI generates engaging videos with custom music and stunning visuals. Perfect for growing your YouTube channel without appearing on camera.',
    examplePrompts: ['Viral YouTube video idea', 'YouTube content with music', 'Faceless YouTube channel', 'Engaging YouTube content AI'],
    routeCategory: 'platform'
  },

  '/youtube-shorts-without-filming': {
    path: '/youtube-shorts-without-filming',
    title: 'Create YouTube Shorts Without Filming Yourself | Gruvi',
    description: 'Grow your YouTube channel with Shorts without appearing on camera. AI creates engaging short-form content with visuals and music that get views. Perfect for building a faceless YouTube presence.',
    keywords: 'youtube shorts no camera, faceless youtube, youtube content ai, shorts without filming, youtube growth no camera, ai youtube videos',
    ogTitle: 'Create YouTube Shorts Without Filming Yourself',
    ogDescription: 'Grow your YouTube channel with Shorts without appearing on camera. AI creates content that gets views.',
    twitterTitle: 'Create YouTube Shorts Without Filming Yourself',
    twitterDescription: 'Grow your YouTube channel with Shorts without appearing on camera.',
    breadcrumbName: 'YouTube Shorts Without Filming',
    heroTagline: 'YouTube Growth Without Camera',
    heroHeading: 'Create YouTube Shorts\nWithout Filming Yourself',
    heroSubtext: 'Grow your YouTube channel with Shorts without appearing on camera. AI creates engaging short-form content with visuals and music that get views. Perfect for building a faceless YouTube presence.',
    examplePrompts: ['YouTube Shorts viral content', 'Faceless YouTube channel video', 'Short-form content no filming', 'YouTube growth without camera'],
    routeCategory: 'platform'
  },

  '/instagram-reels-without-camera': {
    path: '/instagram-reels-without-camera',
    title: 'Create Instagram Reels Without a Camera | Gruvi',
    description: 'Create engaging Instagram Reels without filming yourself. AI generates scroll-stopping content with visuals and music that grow your following. Perfect for building your Instagram presence without appearing on camera.',
    keywords: 'instagram reels no camera, faceless instagram, reels content ai, instagram without filming, instagram growth no camera, ai instagram videos',
    ogTitle: 'Create Instagram Reels Without a Camera',
    ogDescription: 'Create engaging Instagram Reels without filming. AI generates scroll-stopping content that grows your following.',
    twitterTitle: 'Create Instagram Reels Without a Camera',
    twitterDescription: 'Create engaging Instagram Reels without filming.',
    breadcrumbName: 'Instagram Reels Without Camera',
    heroTagline: 'Instagram Growth Without Filming',
    heroHeading: 'Create Instagram Reels\nWithout a Camera',
    heroSubtext: 'Create engaging Instagram Reels without filming yourself. AI generates scroll-stopping content with visuals and music that grow your following. Perfect for building your Instagram presence without appearing on camera.',
    examplePrompts: ['Instagram Reels trending style', 'Scroll-stopping Reel content', 'Faceless Instagram growth', 'Viral Reel without filming'],
    routeCategory: 'platform'
  },

  '/promote-restaurant-without-filming': {
    path: '/promote-restaurant-without-filming',
    title: 'Promote Your Restaurant Without Filming | Gruvi',
    description: 'Create mouthwatering promotional videos for your restaurant without filming. AI generates appetizing visual content with music that brings customers through your door. Perfect for restaurant owners who want marketing without video production.',
    keywords: 'restaurant promotion no camera, food marketing ai, restaurant videos, food business promotion, faceless restaurant content, ai food videos',
    ogTitle: 'Promote Your Restaurant Without Filming',
    ogDescription: 'Create mouthwatering promotional videos for your restaurant. AI generates appetizing content that brings in customers.',
    twitterTitle: 'Promote Your Restaurant Without Filming',
    twitterDescription: 'Create mouthwatering restaurant promo videos with AI.',
    breadcrumbName: 'Promote Restaurant Without Filming',
    heroTagline: 'Restaurant Marketing Made Easy',
    heroHeading: 'Promote Your Restaurant\nWithout Filming',
    heroSubtext: 'Create mouthwatering promotional videos for your restaurant without filming. AI generates appetizing visual content with music that brings customers through your door.',
    examplePrompts: ['Restaurant promo video', 'Food menu showcase', 'Dining experience content', 'Local restaurant marketing'],
    routeCategory: 'promotional'
  },

  '/promote-online-course-no-camera': {
    path: '/promote-online-course-no-camera',
    title: 'Promote Your Online Course Without a Camera | Gruvi',
    description: 'Market your online course or coaching business without filming yourself. Create compelling promotional videos with AI that showcase your expertise and convert viewers into students. Perfect for course creators who prefer staying off camera.',
    keywords: 'online course promotion no camera, course marketing ai, coaching promotion videos, faceless course creator, ai course marketing, education content no filming',
    ogTitle: 'Promote Your Online Course Without a Camera',
    ogDescription: 'Market your online course without filming. AI creates compelling promo videos that convert viewers into students.',
    twitterTitle: 'Promote Your Online Course Without a Camera',
    twitterDescription: 'Market your online course without filming.',
    breadcrumbName: 'Promote Online Course',
    heroTagline: 'Course Marketing Without Camera',
    heroHeading: 'Promote Your Online Course\nWithout a Camera',
    heroSubtext: 'Market your online course or coaching business without filming yourself. Create compelling promotional videos with AI that showcase your expertise and convert viewers into students.',
    examplePrompts: ['Online course promo video', 'Coaching program marketing', 'Educational content faceless', 'Course launch video content'],
    routeCategory: 'promotional'
  },

  '/promote-music-without-filming': {
    path: '/promote-music-without-filming',
    title: 'Promote Your Music Without Filming Yourself | Gruvi',
    description: 'Create stunning music videos and promotional content without appearing on camera. AI generates visual content that matches your sound and helps you build a fanbase. Perfect for musicians and artists who want promotion without the spotlight.',
    keywords: 'music promotion no camera, musician marketing ai, music video no filming, artist promotion faceless, ai music videos, band marketing no camera',
    ogTitle: 'Promote Your Music Without Filming Yourself',
    ogDescription: 'Create stunning music videos without appearing on camera. AI generates visuals that match your sound.',
    twitterTitle: 'Promote Your Music Without Filming Yourself',
    twitterDescription: 'Create stunning music videos without appearing on camera.',
    breadcrumbName: 'Promote Music Without Filming',
    heroTagline: 'Music Promotion Without Camera',
    heroHeading: 'Promote Your Music\nWithout Filming Yourself',
    heroSubtext: 'Create stunning music videos and promotional content without appearing on camera. AI generates visual content that matches your sound and helps you build a fanbase.',
    examplePrompts: ['Music video without filming', 'Artist promo content faceless', 'Band marketing video ai', 'Song promotion visual content'],
    routeCategory: 'contentCreator'
  },

  '/affiliate-marketing-without-camera': {
    path: '/affiliate-marketing-without-camera',
    title: 'Affiliate Marketing Without a Camera | Gruvi',
    description: 'Build a profitable affiliate marketing business without filming yourself. Create product review videos and promotional content with AI. Perfect for affiliate marketers who want to earn commissions without appearing on camera.',
    keywords: 'affiliate marketing no camera, faceless affiliate, product reviews ai, affiliate content creation, no face affiliate marketing, ai affiliate videos',
    ogTitle: 'Affiliate Marketing Without a Camera',
    ogDescription: 'Build a profitable affiliate business without filming. AI creates product videos that earn commissions.',
    twitterTitle: 'Affiliate Marketing Without a Camera',
    twitterDescription: 'Build a profitable affiliate business without filming.',
    breadcrumbName: 'Affiliate Marketing Without Camera',
    heroTagline: 'Earn Without Filming',
    heroHeading: 'Affiliate Marketing\nWithout a Camera',
    heroSubtext: 'Build a profitable affiliate marketing business without filming yourself. Create product review videos and promotional content with AI. Perfect for affiliate marketers who want to earn commissions without appearing on camera.',
    examplePrompts: ['Affiliate product review video', 'Commission-earning content', 'Product recommendation video', 'Faceless affiliate marketing'],
    routeCategory: 'contentCreator'
  },
