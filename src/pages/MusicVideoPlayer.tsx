            ...
            <Box sx={{ mb: 2 }}>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                {socialUploadPlatforms.map((platform) => {
                  ...
                  // Use blue for pending state - looks cleaner than platform brand colors
                  const pendingColor = '#007AFF';
                  ...
                  return (
                    ...
                    >
                      ...
                      <Box sx={{ 
                        ...
                        bgcolor: isComplete ? (isSuccess ? 'rgba(52,199,89,0.1)' : 'rgba(255,59,48,0.1)') : 'rgba(0,122,255,0.1)',
                        display: 'flex', alignItems: 'center', justifyContent: 'center',
                        flexShrink: 0,
                      }}>
                        {platform === 'youtube' && <YouTube sx={{ fontSize: 18, color: isComplete ? (isSuccess ? '#34C759' : '#FF3B30') : pendingColor }} />}
                        {platform === 'tiktok' && (
                          <Box component="svg" viewBox="0 0 24 24" sx={{ width: 16, height: 16, fill: isComplete ? (isSuccess ? '#34C759' : '#FF3B30') : pendingColor }}>
                      ...
                      {/* Status Indicator */}
                      {!isComplete && (
                        <CircularProgress size={18} sx={{ color: pendingColor }} />
                      )}
