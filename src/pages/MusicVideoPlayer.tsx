            ...
            <Box sx={{ mb: 2 }}>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                {socialUploadPlatforms.map((platform) => {
                  ...
                  const color = platformColors[platform] || '#007AFF';
                  ...
                  return (
                    ...
                    >
                      ...
                      <Box sx={{ 
                        ...
                        {platform === 'youtube' && <YouTube sx={{ fontSize: 18, color }} />}
                        {platform === 'tiktok' && (
                          <Box component="svg" viewBox="0 0 24 24" sx={{ width: 16, height: 16, fill: color }}>
