    ...
    <Box sx={{ minHeight: '100vh', background: '#0D0D0F' }}>
      ...
      <Box sx={{ position: 'relative', background: '#140E0A' }}>
        <VideoShowcase
          ...
          subtitle="Create stunning product videos with AI avatars, custom music, and cinematic effects."
          badge="UGC Content"
          ctaText="Start Creating"
          ctaLink={isLoggedIn ? '/create/video' : undefined}
          onCtaClick={!isLoggedIn ? handleOpenAuth : undefined}
          ...
          ctaButtonGradient="linear-gradient(135deg, #F97316 0%, #EA580C 50%, #C2410C 100%)"
        />
        <SectionDivider />
      </Box>
