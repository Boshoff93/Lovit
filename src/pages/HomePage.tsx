        ...
        <Container maxWidth="lg">
          <Box sx={{ mb: 2.5 }}>
            <Typography
              ...
              sx={{ fontSize: { xs: '1.4rem', md: '1.6rem' }, fontWeight: 700, color: '#1D1D1F', mb: 0.5 }}
            >
              Distribute Everywhere. No Copyright Worries.
            </Typography>
            <Typography sx={{ color: '#86868B', fontSize: '0.85rem' }}>
              Your AI-generated content is 100% original - post to YouTube, TikTok, Instagram & Spotify without strikes or claims
            </Typography>
          </Box>
          ...
          <ScrollableCarousel id="platforms-carousel">
            {[
              ...
              { id: 'spotify', name: 'Spotify', color: '#1DB954', image: '/music-apps/spotify.png', svgPath: null },
              { id: 'apple-music', name: 'Apple Music', color: '#FA233B', image: '/music-apps/apple.png', svgPath: null },
              { id: 'amazon-music', name: 'Amazon Music', color: '#25D1DA', image: '/music-apps/amazon.png', svgPath: null },
              { id: 'soundcloud', name: 'SoundCloud', color: '#FF5500', image: '/music-apps/sound.png', svgPath: null },
            ].map((platform) => (
              <Box
                key={platform.id}
