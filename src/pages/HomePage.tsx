        ...
        <Container maxWidth="lg">
          ...
          <Box sx={{ 
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 1 }}>
              ...
              >
                <Box component="img" src="/music-apps/spotify.png" alt="Spotify" sx={{ width: { xs: 32, md: 40 }, height: { xs: 32, md: 40 }, objectFit: 'contain' }} />
              </Box>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 1 }}>
              ...
              >
                <Box component="img" src="/music-apps/apple.png" alt="Apple Music" sx={{ width: { xs: 32, md: 40 }, height: { xs: 32, md: 40 }, objectFit: 'contain' }} />
              </Box>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 1 }}>
              ...
              >
                <Box component="img" src="/music-apps/amazon.png" alt="Amazon Music" sx={{ width: { xs: 32, md: 40 }, height: { xs: 32, md: 40 }, objectFit: 'contain' }} />
              </Box>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 1 }}>
              <Box
                sx={{
                  ...
                  height: { xs: 56, md: 72 },
                  borderRadius: '16px',
                  background: 'linear-gradient(135deg, rgba(255,85,0,0.1) 0%, rgba(255,85,0,0.2) 100%)',
                  ...
                  transition: 'all 0.2s ease',
                  cursor: 'pointer',
                  '&:hover': { transform: 'translateY(-4px) scale(1.05)', boxShadow: '0 8px 24px rgba(255,85,0,0.2)' },
                }}
              >
                <Box component="img" src="/music-apps/sound.png" alt="SoundCloud" sx={{ width: { xs: 32, md: 40 }, height: { xs: 32, md: 40 }, objectFit: 'contain' }} />
              </Box>
              <Typography sx={{ fontSize: { xs: '0.7rem', md: '0.75rem' }, fontWeight: 600, color: '#86868B' }}>SoundCloud</Typography>
            </Box>
          </Box>
        </Container>
      </Box>
